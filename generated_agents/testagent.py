...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Run the TestAgent agent.")
    parser.add_argument("--task", default="Help me with a task", help="The task to be performed by the agent")
