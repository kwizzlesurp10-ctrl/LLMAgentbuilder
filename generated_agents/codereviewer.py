...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Run the CodeReviewer agent.")
    parser.add_argument("--task", default="Build  simple python scripts", help="The task to be performed by the agent")
    ...
    try:
        agent = CodeReviewer(api_key=api_key)
        ...
        if args.search_model:
            ...
            print(f"Running CodeReviewer with task: {args.task}\n")
